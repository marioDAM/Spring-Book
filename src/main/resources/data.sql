...
values (NEXTVAL('bookSequence'), 'Señor de los anillos |', 'J.R.R.Tolkien', 976418, '1955-10-12', 0,
        'Acción y aventuras', 'Descripcion');
insert into Book (id, name, author, ISBN, created_at, isReserved, category, description)
values (NEXTVAL('bookSequence'), 'Harry Potter', 'JK.Rowling', 65658, '1980-02-20', 0, 'Acción y aventuras',
        'Descripcion');
insert into Book (id, name, author, ISBN, created_at, isReserved, category, description)
values (NEXTVAL('bookSequence'), 'El niño con el pijama de rayas', 'J.Boyne', 35245,
        '2006-05-19', 0, 'Acción y aventuras', 'Descripcion');
insert into Book (id, name, author, ISBN, created_at, isReserved, category, description)
values (NEXTVAL('bookSequence'), 'Don Quijote', 'M. de Cervantes', 615611, '1605-08-2', 0, 'Acción y aventuras',
        'Descripcion');
insert into Book (id, name, author, ISBN, created_at, isReserved, category, description)
