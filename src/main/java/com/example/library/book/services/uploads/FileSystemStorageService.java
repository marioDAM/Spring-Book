...
import com.example.library.book.controllers.files.FilesRestController;
import com.example.library.book.errors.storage.StorageException;
import com.example.library.book.errors.storage.StorageFileNotFoundException;
...
public class FileSystemStorageService implements StorageService {
     ...
     * <p>
     * Modificamos el original del ejemplo de Spring para cambiar el name
     * del fichero a almacenar. Como lo asociamos al objeto a subir usaremos el ID de
     * dicho objeto como name de fichero.
    ...
    /**
     * Método que es capaz de cargar un fichero a partir de su name
